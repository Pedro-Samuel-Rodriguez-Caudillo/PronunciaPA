...
from ipa_core.testing.contracts.textref import TextRefContract


class TestGraphemeTextRef(TextRefContract):
    ...
    @pytest.mark.asyncio
    async def test_grapheme_textref_specific(self):
    ...
    @pytest.mark.asyncio
    async def test_grapheme_textref_normalization(self):
        provider = GraphemeTextRef()
