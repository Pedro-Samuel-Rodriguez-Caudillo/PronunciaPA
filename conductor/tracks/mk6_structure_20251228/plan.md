...
- [ ] Task: Move `ipa_core/api/http.py` to `ipa_server/main.py`.
- [ ] Task: Refactor `ipa_core/api/cli.py` to `ipa_core/interfaces/cli.py` and update entry points.
- [ ] Task: Clean up `ipa_core/backends` (keeping only stubs/built-ins).
